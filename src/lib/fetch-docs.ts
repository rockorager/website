...
export async function loadDocsPage(docsDirectory: string, slug: string): Promise<DocsPageData> {
...
async function loadDocsPageFromRelativeFilePath(relativeFilePath: string): Promise<DocsPageData> {
...
export async function loadAllDocsPageSlugs(docsDirectory: string): Promise<Array<string>> {
